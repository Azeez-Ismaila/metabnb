...
const Nav = ({ setModal, modal }) => {
  ...
  return (
    <div className="flex  justify-between md:justify-around items-center p-3 my-2">
      <Link to="/">
        <svg
          width="233"
          height="38"
      ...
      <button
        className="hidden md:flex rounded-lg bg-primary text-white p-2 px-4"
        onClick={() => {
          setModal(!modal);
        }}
      >
      ...
      {nav && (
        <div className="w-full z-10 fixed top-0 left-0 bg-primary transition-all duration-2000">
          <div>
            <FaTimes
              size={40}
              color={"white"}
              className="md:hidden float-right m-6"
              onClick={() => setNavbar(!nav)}
            />
          </div>
          <div className="flex flex-col gap-4 list-none p-10 text-white ">
            <li>
              <Link to="/">Home</Link>
            </li>
            <li>
            ...
            <button
              className=" rounded-lg bg-white text-primary p-2 px-4"
              onClick={() => {
                setModal(!modal);
              }}
            >
